...
%  }
    \begin{center}
    \emph{Dedication}
%	\emph{To my grandmother Lidia, and to the memory of my grandmother, Norma.}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%      
    ...
    \input{chapters/technologies-employed}
    \input{chapters/data}
    \input{chapters/time-travel}
...
%    \addcontentsline{toc}{chapter}{Bibliografia}
    ...
    %\bibliography{biblio}\addcontentsline{toc}{chapter}{Bibliography}
%    \nocite{*}
